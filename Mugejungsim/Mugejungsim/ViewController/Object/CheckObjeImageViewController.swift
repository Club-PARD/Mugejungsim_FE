...
class CheckObjeImageViewController: UIViewController {
    ...
    private func setConstraints() {
        NSLayoutConstraint.activate([
            // textLabel 위치
            textLabel.topAnchor.constraint(equalTo: view.topAnchor, constant: 175),
            textLabel.centerXAnchor.constraint(equalTo: view.centerXAnchor),
            
            touchLabel.topAnchor.constraint(equalTo: textLabel.bottomAnchor, constant: 14),
            ...
            bottleImageView.centerYAnchor.constraint(equalTo: view.centerYAnchor, constant: 50),
